...
**Then**:
- `\dt` 输出包含 10 张表：category, model_type, tag, model, model_version, model_tag, model_type_tag, version_lock, upload_task, convert_task
...
**When**:
- 执行 `INSERT INTO category (name) VALUES ('TextGeneration')`
